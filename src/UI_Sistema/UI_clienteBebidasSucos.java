 ...
 * @author jessi
 */
public class UI_clienteBebidasSucos extends javax.swing.JFrame {

    /**
     * Creates new form UI_clienteBebidasRefrigerantes
     */
    public UI_clienteBebidasSucos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_clienteBebidasSucos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_clienteBebidasSucos().setVisible(true);
            }
        });
    }
