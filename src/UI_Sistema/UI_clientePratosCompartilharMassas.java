 ...
 * @author jessi
 */
public class UI_clientePratosCompartilharMassas extends javax.swing.JFrame {

    /**
     * Creates new form UI_clientePratosCompartilharParmegianas
     */
    public UI_clientePratosCompartilharMassas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_clientePratosCompartilharMassas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_clientePratosCompartilharMassas().setVisible(true);
            }
        });
    }
