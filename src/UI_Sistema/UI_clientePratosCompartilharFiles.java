 ...
 * @author jessi
 */
public class UI_clientePratosCompartilharFiles extends javax.swing.JFrame {

    /**
     * Creates new form UI_clientePratosCompartilharParmegianas
     */
    public UI_clientePratosCompartilharFiles() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_clientePratosCompartilharFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_clientePratosCompartilharFiles().setVisible(true);
            }
        });
    }
