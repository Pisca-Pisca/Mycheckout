 ...
 * @author jessi
 */
public class UI_clientePratosIndividuaisCombos extends javax.swing.JFrame {

    /**
     * Creates new form UI_clientePratosCompartilharParmegianas
     */
    public UI_clientePratosIndividuaisCombos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_clientePratosIndividuaisCombos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_clientePratosIndividuaisCombos().setVisible(true);
            }
        });
    }
