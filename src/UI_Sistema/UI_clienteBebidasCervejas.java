 ...
 * @author jessi
 */
public class UI_clienteBebidasCervejas extends javax.swing.JFrame {

    /**
     * Creates new form UI_clienteBebidasRefrigerantes
     */
    public UI_clienteBebidasCervejas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_clienteBebidasCervejas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UI_clienteBebidasCervejas().setVisible(true);
            }
        });
    }
