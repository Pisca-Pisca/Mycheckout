 ...
 * @author nicol
 */
public class UI_modalCriaSubconta extends javax.swing.JDialog {

    /**
     * Creates new form UI_modalSenhaAdmin
     */
    public UI_modalCriaSubconta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_modalCriaSubconta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UI_modalCriaSubconta dialog = new UI_modalCriaSubconta(new javax.swing.JFrame(), true);
