 ...
 * @author nicol
 */
public class UI_modalChamarGarcom extends javax.swing.JDialog {

    /**
     * Creates new form UI_modalSenhaAdmin
     */
    public UI_modalChamarGarcom(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_modalChamarGarcom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UI_modalChamarGarcom dialog = new UI_modalChamarGarcom(new javax.swing.JFrame(), true);
