 ...
 * @author nicol
 */
public class UI_modalConfirmarPagamento extends javax.swing.JDialog {

    /**
     * Creates new form UI_modalSenhaAdmin
     */
    public UI_modalConfirmarPagamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_modalConfirmarPagamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UI_modalConfirmarPagamento dialog = new UI_modalConfirmarPagamento(new javax.swing.JFrame(), true);
