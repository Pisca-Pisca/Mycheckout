 ...
 * @author nicol
 */
public class UI_modalCadastroSucesso extends javax.swing.JDialog {

    /**
     * Creates new form UI_modalSenhaAdmin
     */
    public UI_modalCadastroSucesso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UI_modalCadastroSucesso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UI_modalCadastroSucesso dialog = new UI_modalCadastroSucesso(new javax.swing.JFrame(), true);
